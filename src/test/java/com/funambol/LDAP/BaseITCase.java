...
public abstract class BaseITCase extends AbstractLdapTestUnit  implements TestConstants {

	protected static FunambolLogger logger =  new FunambolLogger(BaseITCase.class);

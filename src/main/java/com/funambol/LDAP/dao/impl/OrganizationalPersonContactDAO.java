...
/**
 * Contact DAO for organizationalPerson objectClass
 * @author dyerger
 * modified from PersonContactDAO.java by:
 * @author rpolli
 *
 */

public class OrganizationalPersonContactDAO extends ContactDAO implements ContactDAOInterface {
	...
	public OrganizationalPersonContactDAO() {
	...
	//	String entryId = LdapUtils.getPrintableAttribute(attrs.get(ldapId));
		...
		val = LdapUtils.getPrintableAttribute(attrs.get("co")); 
		if (! val.equals(""))
